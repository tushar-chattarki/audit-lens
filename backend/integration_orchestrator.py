...
def run_full_pipeline(
    ...
    ai_summary_text = (
        ...
        f"identified {exc_count} exception{'s' if exc_count != 1 else ''} out of "
        f"{total_count} checks performed. {pass_count} checks tied out successfully."
    )
    if key_issues:
